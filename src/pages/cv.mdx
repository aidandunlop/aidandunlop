...
<Section title="Recent experience" preExpanded="Sky" useAccordion>
    <Subsection title="Sky">
        <Item title="Machine Learning Engineer" time="Oct 2020 - Present">
            Building a framework for deploying ML models into production in a robust and scalable way. Concerned about popularity bias in recommendation systems. Improving skills in Python, TensorFlow, TensorFlow Serving, TFX, Kubeflow and gRPC. Recently took part in [a virtual discussion with DataTonic on Personalisation and MLOps](https://datatonic.com/insights/tonictalk-sky-personalisation-at-scale/).
        </Item>
