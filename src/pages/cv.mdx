...
**Machine Learning skills**: Python, TensorFlow, TFX, Pytorch, Pandas, and SciKit Learn.
...
<Section title="Experience" preExpanded="Sky" useAccordion>
    <Subsection title="Sky">
        <Item title="Machine Learning Engineer" time="Oct 2020 - Present">
            Deploying ML models for personalisation into production in an ethical and scalable way. Concerned about popularity bias in recommendation systems. Improving skills in Python, TensorFlow, TFX and Kubeflow. Recently took part in [a virtual discussion with DataTonic on Personalisation and MLOps](https://datatonic.com/insights/tonictalk-sky-personalisation-at-scale/).
        </Item>
...
<Section title="Education" preExpanded="Springboard,University of Manchester" useAccordion>
