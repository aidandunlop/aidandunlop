...
<Section title="Recent experience" preExpanded="Sky" useAccordion>
    <Subsection title="Sky">
        <Item title="Machine Learning Engineer" time="Oct 2020 - Present">
            Building a framework for deploying ML models into production in a robust and scalable way. Concerned about popularity bias in recommendation systems. Improving skills in Scala, Python, TensorFlow, TensorFlow Serving, TFX, Kubernetes and gRPC.
        </Item>
